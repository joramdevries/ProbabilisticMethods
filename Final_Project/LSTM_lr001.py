...
def LSTM_function(data, input_data, output, model_name):
    ...
    plt.savefig(f'Plots/PMWE_LSTM_Model_{model_name}_{output}_loss_lr001.eps')
    plt.savefig(f'Plots/PMWE_LSTM_Model_{model_name}_{output}_loss_lr001.jpg')
    plt.show()
    ...
    model.save(f'PMWE_LSTM_Model_{model_name}_{output}_lr001.h5')
    
    
def LSTM_testing(data, input_data, outputs, model_name):
    
    # Load the model
    model = load_model(f'PMWE_LSTM_Model_{model_name}_{outputs}_lr001.h5')
    ...
    plt.savefig(f'Plots/PMWE_LSTM_Model_{model_name}_{outputs}_QQ_lr001.eps')
    plt.savefig(f'Plots/PMWE_LSTM_Model_{model_name}_{outputs}_QQ_lr001.jpg')
    ...
    plt.savefig(f'Plots/PMWE_LSTM_Model_{model_name}_{outputs}_Predict_vs_Actual_lr001.eps')
    plt.savefig(f'Plots/PMWE_LSTM_Model_{model_name}_{outputs}_Predict_vs_Actual_lr001.jpg')
    ...
    for i in range(len(Y_validation[0])):
        ...
        plt.savefig(f'Plots/PMWE_LSTM_Model_{model_name}_{Y_data.columns[i]}_validation_predictions_lr001.eps')
        plt.savefig(f'Plots/PMWE_LSTM_Model_{model_name}_{Y_data.columns[i]}_validation_predictions_lr001.jpg')
        ...
        plt.savefig(f'Plots/PMWE_LSTM_Model_{model_name}_{Y_data.columns[i]}_validation_predictions_2_lr001.eps')
        plt.savefig(f'Plots/PMWE_LSTM_Model_{model_name}_{Y_data.columns[i]}_validation_predictions_2_lr001.jpg')
        ...
        # plt.plot(rounded_pred_val,'.', label = 'rounded predictions')
        plt.xlim([0,600])
        plt.savefig(f'Plots/PMWE_LSTM_Model_{model_name}_{Y_data.columns[i]}_validation_predictions_xlim600_lr001.eps')
        plt.savefig(f'Plots/PMWE_LSTM_Model_{model_name}_{Y_data.columns[i]}_validation_predictions_xlim600_lr001.jpg')
        ...
        plt.xlim([100,600])
        plt.savefig(f'Plots/PMWE_LSTM_Model_{model_name}_{Y_data.columns[i]}_validation_predictions_xlim600_offset_lr001.eps')
        plt.savefig(f'Plots/PMWE_LSTM_Model_{model_name}_{Y_data.columns[i]}_validation_predictions_xlim600_offset_lr001.jpg')
    ...
    mae_df.to_csv(f'CSV/mae_results_{model_name}_lr001.csv', index=False)
    ...
    for i in range(len(Y_validation[0])):
        ...
        plt.savefig(f'Plots/PMWE_LSTM_Model_{model_name}_{Y_data.columns[i]}_test_predictions_lr001.eps')
        plt.savefig(f'Plots/PMWE_LSTM_Model_{model_name}_{Y_data.columns[i]}_test_predictions_lr001.jpg')
        ...
        # plt.plot(rounded_pred_val,'.', label = 'rounded predictions')
        plt.xlim([0,600])
        plt.savefig(f'Plots/PMWE_LSTM_Model_{model_name}_{Y_data.columns[i]}_test_predictions_xlim600_lr001.eps')
        plt.savefig(f'Plots/PMWE_LSTM_Model_{model_name}_{Y_data.columns[i]}_test_predictions_xlim600_lr001.jpg')
